...
public class BikeRental {
    ...
    private final RentalService rentalService = new RentalService(activeRentalsList);
    ...
    public void simulateApplicationInput(RegisteredUsers user) {
        ...
        if (bikeID == null){
            ...
            System.out.println("Bike found! Starting rental...");
            rentalService.startRental(bikeID, emailAddress, tripStartTime);

            System.out.println("Press any key to end trip...");
            scanner.nextLine();

            rentalService.endRental(bikeID,user);
            rentalService.removeTrip(bikeID);
        }
